...
trait ValidatesJWT
{
     ...
     * @return bool $payload
     */
    protected function validateTimestamps(array $payload) : bool {
...
class JWT
{
     ...
     */
    public function __construct($key, $maxAge = 3600, $algo = 'HS256', $leeway = 0, $pass = null)
    {
    ...
    /**
     * Encodes and returns a json web token.
     * 
     * @param string $key
     ...
     * @return string token
     */
    public static function generate(string $key, string $content) : string {
    ...
    public function decode($token)
    {
        ...
        if (!$this->validateTimestamps($payload)) {
            return null;
        }
    ...
    public function isExpired(string $token) : bool {
        ...
        return !$this->validateTimestamps($payload);
