...
class Backup_Database {
    ...
    public function __construct($ops) {
        ...
        $def = arr($def)->force($ops);

        $this->host                    = $def['host'];
        $this->username                = $def['username'];
        $this->passwd                  = $def['password'];
        $this->dbName                  = $def['database'];
        $this->charset                 = $def['charset'];
        $this->conn                    = $this->initializeDatabase();
        $this->backupDir               = dirname($def['file']);
        $this->backupFile              = basename($def['file']);
        $this->gzipBackupFile          = $def['zip'];
        $this->disableForeignKeyChecks = $def['disableForeignKeyChecks'];
        $this->batchSize               = $def['batchSize'];
        $this->output                  = '';
    }
